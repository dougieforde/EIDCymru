<?php
class ScotEID_FindLotsByDepartureLocationRequest extends ScotEID_AbstractRequest
{
  ...
  public function before() {
    ...
    $holding = ScotEID_Holding::try_parse($this->DepartureLocation);
  ...
  {
    $response = new ScotEID_FindLotsByDepartureLocationResponse();
