...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid < 0) {
			...
			// i've set the color white because I don't know how to turn the bloody thing off
			$this->SetLineStyle(array('width' => 5 / $this->k, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(255, 255, 255)));
